...
In standard economic theory an agent is assumed to be a \term{homo oeconomicus}, which portrays the person as consistently rational and narrowly self-interested, usually pursuing his subjectively-defined end optimally; he therefore follows two main characteristics:
\begin{itemize}
	\item \term{Rationality}
	\item \term{Utility maximisation}
\end{itemize}
...
\begin{itemize}
	\item \term{prescriptive} - means containing an indication of approval or disapproval
	\item \term{normative} - means relating to a given model
\end{itemize}
approaches.